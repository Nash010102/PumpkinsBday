...
function goToScreen(screenId) {
  ...
  if (screenId === 'screen-real') startConfetti();
  if (screenId === 'screen-real2') startHeartShower();
}
...
function replayAll() {
  ...
  heartShowerStarted = false;
  const heartContainer = document.getElementById('heart-shower');
